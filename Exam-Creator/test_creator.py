"""
Test generator runs to generate the quiz with the Open AI call. It also has safety 
features like creating the prompt here for us and asking us to verify the prompt. 

We just added things here to possibly raise some errors:
- if we ask for > 6 questions, it says Hey, be careful it might be expensive
- if we ask for > 5 multiple choice answers, we've seen the model gets a little weak 
    and starts to lose track of the token history. 
"""
