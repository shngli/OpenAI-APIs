"""
create_full_test() will ask the teach for input:
- What topic would you like to create a test on eg. history
- How many test questions would you like to have eg. 4 questions
- How many possible answers per question would you like to have eg. 4 multiple choice 
    answers per question

Then the script creates the student view and extracts those answers.
"""
...
### We have a dummy test here in case we want to test this and 
### not keep accidentally burning our credits. 
...
class Teacher:
    ...
    def create_full_test(self):
        ...
        num_questions = int(input("How many test questions would you like to have? "))
