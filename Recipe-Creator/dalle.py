"""
Extract the recipe title from the generated recipe to create the food image prompt. 
Once we verify the prompt, generate_image() calls the Open AI's Image.create() method 
