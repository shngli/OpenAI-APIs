...
def create_prompt(title):
    prompt = """Shayne's Website
 
 Biography
 I am a data scientist with keen interest in machine learning!


 Blog

 Sept 01, 2023
 Title: Why AI will never replace human data analyst
 tags: tech, machine-learning, data-analytics
 Summary:  I talk about the cons of machine learning in data analysis. I explain why I think that AI will never replace human data analyst.
