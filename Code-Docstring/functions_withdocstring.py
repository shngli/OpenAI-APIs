"""
functions_withdocstring.py is written by main.py after reading the defined functions in 
functions.py and merging them with the documentation strings generated by OpenAI
"""
