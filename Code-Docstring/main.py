"""
main.py reads the function that we have previously defined, then create a new .py file
with those functions that include the automatically generated docstrings.
Ie. this is a quick instant documentation where we give it a .py file containing our
defined functions, and it will write a new .py file that has the docstrings.
"""
...
### Set up the docstring prompt that we will send to OpenAI Completion API
def docstring_prompt(code):
    prompt = f"{code}\n # A high quality python docstring of the above python function:\n\"\"\""
    return prompt

### Merge the generated docstring with the function 
...
### Accepts all modules inside functions.py
### Use inspect.isfunction to inspect and confirm whether the member is a function
...
### Send the prompt to Completion API to generate docstring for each function
...
if __name__ == "__main__":
    ...
    ### Write the functions merged with docstrings to a new file
