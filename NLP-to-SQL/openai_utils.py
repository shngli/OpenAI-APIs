"""
Purpose: 
- create_table_definition_prompt() will automatically set up the prompts for us
- user_query_input() will ask us what we want to know about the data. 
- combine_prompts() combines the prompts
- send_to_openai() sends the prompt to Open AI and gets back the response. 
"""
