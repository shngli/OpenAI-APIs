...
"""
Purpose: Note that we have the CSV file hardcoded here. Everything else is just going 
to load in our data, report the data format, fix the SQL prompt, wait for the user input 
as what they want to know aout sales, send that to open AI and then return the results.
"""
